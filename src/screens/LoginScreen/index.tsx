...
export default function LoginScreen() {
  ...
  return (
    <Box className={classes.container}>
      <Box className={classes.loginModal}>
        ...
        <InputBase
          ...
          className={classes.inputBase}
        ></InputBase>
       <Box sx={{ borderBottom: 1, marginTop:2, paddingBottom:3, borderColor:'#eee' }}>
       <Button onClick={() => {
         setShowError(!showError)
       }} variant="contained" color='neutral' fullWidth >Login</Button>
       </Box>
    <Box sx={{paddingTop:2}}>
    <p className={classes.text}>
    ...
    <Box sx={{paddingTop:1}}>
    <a className={classes.link} href="/forgot_password">*If you forgot your password, re-issue new password here</a>
    </Box>
